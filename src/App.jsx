      ...
      <div className="max-w-6xl mx-auto space-y-12 md:space-y-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white neo-card p-6">
          <div className="w-full flex flex-col justify-center items-center md:items-start">
            ...
            <div className="flex p-1 bg-slate-100 neo-border gap-1 w-fit justify-center md:justify-start">
              <button 
          ...
          <div className="space-y-2 w-full">
            <h4 className="text-[10px] font-black uppercase tracking-widest text-black/50 italic text-center md:text-right">Budget Split Presets</h4>
